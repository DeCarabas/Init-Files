...
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$StrokeDashCap
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$StrokeDashOffset
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$StrokeEndLineCap
,
	[Parameter(ParameterSetName='Default')]
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "Rectangle not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "Rectangle in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Shapes.Rectangle {
<#
.Synopsis
   Create a new Rectangle object
.Description
   Generates a new System.Windows.Shapes.Rectangle object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Shapes.Rectangle
   $All = Get-Parameter New-System.Windows.Shapes.Rectangle | ForEach-Object { $_.Key } | Sort
}
PROCESS {


   # The content of System.Windows.Shapes.Rectangle is not a collection
   # So if we're in a pipeline, make a new Rectangle each time
   if($_) { 
      $DObject = New-Object System.Windows.Shapes.Rectangle
   }
...
New-System.Windows.Shapes.Rectangle @PSBoundParameters
