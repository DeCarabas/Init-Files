...
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$MinOrphanLines
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$MinWidowLines
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$Name
,
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "Paragraph not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "Paragraph in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Documents.Paragraph {
<#
.Synopsis
   Create a new Paragraph object
.Description
   Generates a new System.Windows.Documents.Paragraph object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Documents.Paragraph
   $All = Get-Parameter New-System.Windows.Documents.Paragraph | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Documents.Paragraph @PSBoundParameters
