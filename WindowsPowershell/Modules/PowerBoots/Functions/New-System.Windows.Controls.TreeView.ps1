...
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SelectedItemChanged
,
	[Parameter(ParameterSetName='Default')]
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "TreeView not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "TreeView in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.TreeView {
<#
.Synopsis
   Create a new TreeView object
.Description
   Generates a new System.Windows.Controls.TreeView object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.TreeView
   $All = Get-Parameter New-System.Windows.Controls.TreeView | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.TreeView @PSBoundParameters
