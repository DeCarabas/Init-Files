...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "FixedPage not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "FixedPage in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Documents.FixedPage {
<#
.Synopsis
   Create a new FixedPage object
.Description
   Generates a new System.Windows.Documents.FixedPage object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Documents.FixedPage
   $All = Get-Parameter New-System.Windows.Documents.FixedPage | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Documents.FixedPage @PSBoundParameters
