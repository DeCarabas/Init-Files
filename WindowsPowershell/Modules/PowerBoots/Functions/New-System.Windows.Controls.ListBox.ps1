...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "ListBox not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "ListBox in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.ListBox {
<#
.Synopsis
   Create a new ListBox object
.Description
   Generates a new System.Windows.Controls.ListBox object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.ListBox
   $All = Get-Parameter New-System.Windows.Controls.ListBox | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.ListBox @PSBoundParameters
