...
PARAM(
	...
	[Switch]$AffectsArrange
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$AffectsMeasure
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$AffectsParentArrange
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$AffectsParentMeasure
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$AffectsRender
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$BindsTwoWayByDefault
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$CoerceValueCallback
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$DefaultUpdateSourceTrigger
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$DefaultValue
,
...
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsAnimationProhibited
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsNotDataBindable
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$Journal
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$OverridesInheritanceBehavior
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$PropertyChangedCallback
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$SubPropertiesDoNotAffectRender
,
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "FrameworkPropertyMetadata not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "FrameworkPropertyMetadata in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.FrameworkPropertyMetadata {
<#
.Synopsis
   Create a new FrameworkPropertyMetadata object
.Description
   Generates a new System.Windows.FrameworkPropertyMetadata object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.FrameworkPropertyMetadata
   $All = Get-Parameter New-System.Windows.FrameworkPropertyMetadata | ForEach-Object { $_.Key } | Sort
}
PROCESS {


   # The content of System.Windows.FrameworkPropertyMetadata is not a collection
   # So if we're in a pipeline, make a new FrameworkPropertyMetadata each time
   if($_) { 
      $DObject = New-Object System.Windows.FrameworkPropertyMetadata
   }
...
New-System.Windows.FrameworkPropertyMetadata @PSBoundParameters
