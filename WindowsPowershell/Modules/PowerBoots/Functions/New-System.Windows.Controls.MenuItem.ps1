...
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsSubmenuOpen
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsSuspendingPopupAnimation
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsTabStop
,
...
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SubmenuOpened
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SubmenuClosed
,
	[Parameter(ParameterSetName='Default')]
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "MenuItem not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "MenuItem in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.MenuItem {
<#
.Synopsis
   Create a new MenuItem object
.Description
   Generates a new System.Windows.Controls.MenuItem object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.MenuItem
   $All = Get-Parameter New-System.Windows.Controls.MenuItem | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.MenuItem @PSBoundParameters
