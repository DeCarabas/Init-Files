...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "WrapPanel not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "WrapPanel in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.WrapPanel {
<#
.Synopsis
   Create a new WrapPanel object
.Description
   Generates a new System.Windows.Controls.WrapPanel object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.WrapPanel
   $All = Get-Parameter New-System.Windows.Controls.WrapPanel | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.WrapPanel @PSBoundParameters
