...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "ToolBarPanel not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "ToolBarPanel in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.Primitives.ToolBarPanel {
<#
.Synopsis
   Create a new ToolBarPanel object
.Description
   Generates a new System.Windows.Controls.Primitives.ToolBarPanel object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.Primitives.ToolBarPanel
   $All = Get-Parameter New-System.Windows.Controls.Primitives.ToolBarPanel | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.Primitives.ToolBarPanel @PSBoundParameters
