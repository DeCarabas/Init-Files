...
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$SelectedContentStringFormat
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$SelectedContentTemplate
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$SelectedContentTemplateSelector
,
	[Parameter(ParameterSetName='Default')]
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "TabControl not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "TabControl in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.TabControl {
<#
.Synopsis
   Create a new TabControl object
.Description
   Generates a new System.Windows.Controls.TabControl object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.TabControl
   $All = Get-Parameter New-System.Windows.Controls.TabControl | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.TabControl @PSBoundParameters
