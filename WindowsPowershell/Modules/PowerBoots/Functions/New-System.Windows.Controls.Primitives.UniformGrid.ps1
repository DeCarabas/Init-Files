...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "UniformGrid not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "UniformGrid in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.Primitives.UniformGrid {
<#
.Synopsis
   Create a new UniformGrid object
.Description
   Generates a new System.Windows.Controls.Primitives.UniformGrid object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.Primitives.UniformGrid
   $All = Get-Parameter New-System.Windows.Controls.Primitives.UniformGrid | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.Primitives.UniformGrid @PSBoundParameters
