...
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$DefaultStylusPointDescription
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$EditingMode
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$EditingModeInverted
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$Effect
,
...
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_StrokeCollected
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_Gesture
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_StrokesReplaced
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_DefaultDrawingAttributesReplaced
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_ActiveEditingModeChanged
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_EditingModeChanged
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_EditingModeInvertedChanged
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SelectionMoving
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SelectionMoved
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_StrokeErasing
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_StrokeErased
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SelectionResizing
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SelectionResized
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SelectionChanging
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_SelectionChanged
,
	[Parameter(ParameterSetName='Default')]
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "InkCanvas not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "InkCanvas in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.InkCanvas {
<#
.Synopsis
   Create a new InkCanvas object
.Description
   Generates a new System.Windows.Controls.InkCanvas object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.InkCanvas
   $All = Get-Parameter New-System.Windows.Controls.InkCanvas | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.InkCanvas @PSBoundParameters
