...
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_Expanded
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_Collapsed
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_Selected
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_Unselected
,
	[Parameter(ParameterSetName='Default')]
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "TreeViewItem not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "TreeViewItem in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.TreeViewItem {
<#
.Synopsis
   Create a new TreeViewItem object
.Description
   Generates a new System.Windows.Controls.TreeViewItem object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.TreeViewItem
   $All = Get-Parameter New-System.Windows.Controls.TreeViewItem | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.TreeViewItem @PSBoundParameters
