...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "StackPanel not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "StackPanel in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.StackPanel {
<#
.Synopsis
   Create a new StackPanel object
.Description
   Generates a new System.Windows.Controls.StackPanel object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.StackPanel
   $All = Get-Parameter New-System.Windows.Controls.StackPanel | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.StackPanel @PSBoundParameters
