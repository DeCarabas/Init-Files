...
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$AutoToolTipPlacement
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$AutoToolTipPrecision
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$Background
,
...
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsSelectionRangeEnabled
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsSnapToTickEnabled
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsTabStop
,
...
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$TickFrequency
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$TickPlacement
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$Ticks
,
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "Slider not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "Slider in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.Slider {
<#
.Synopsis
   Create a new Slider object
.Description
   Generates a new System.Windows.Controls.Slider object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.Slider
   $All = Get-Parameter New-System.Windows.Controls.Slider | ForEach-Object { $_.Key } | Sort
}
PROCESS {


   # The content of System.Windows.Controls.Slider is not a collection
   # So if we're in a pipeline, make a new Slider each time
   if($_) { 
      $DObject = New-Object System.Windows.Controls.Slider
   }
...
New-System.Windows.Controls.Slider @PSBoundParameters
