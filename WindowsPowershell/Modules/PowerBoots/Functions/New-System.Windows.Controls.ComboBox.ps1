...
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$SelectionBoxItemStringFormat
,
	[Parameter(ParameterSetName='Default')]
...
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_DropDownOpened
,
	[Parameter(ParameterSetName='Default')]
	[PSObject]$On_DropDownClosed
,
	[Parameter(ParameterSetName='Default')]
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "ComboBox not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "ComboBox in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.ComboBox {
<#
.Synopsis
   Create a new ComboBox object
.Description
   Generates a new System.Windows.Controls.ComboBox object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.ComboBox
   $All = Get-Parameter New-System.Windows.Controls.ComboBox | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.ComboBox @PSBoundParameters
