...
,
	[Parameter(ParameterSetName='Default')]
	[Switch]$IsOptimalParagraphEnabled
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$Language
,
...
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$MaxPageHeight
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$MaxPageWidth
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$MinPageHeight
,
	[Parameter(ParameterSetName='Default')]
	[Object[]]$MinPageWidth
,
...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "FlowDocument not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "FlowDocument in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Documents.FlowDocument {
<#
.Synopsis
   Create a new FlowDocument object
.Description
   Generates a new System.Windows.Documents.FlowDocument object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Documents.FlowDocument
   $All = Get-Parameter New-System.Windows.Documents.FlowDocument | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Documents.FlowDocument @PSBoundParameters
