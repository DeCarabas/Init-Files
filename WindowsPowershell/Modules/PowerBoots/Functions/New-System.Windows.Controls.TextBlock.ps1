...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "TextBlock not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "TextBlock in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.TextBlock {
<#
.Synopsis
   Create a new TextBlock object
.Description
   Generates a new System.Windows.Controls.TextBlock object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.TextBlock
   $All = Get-Parameter New-System.Windows.Controls.TextBlock | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.TextBlock @PSBoundParameters
