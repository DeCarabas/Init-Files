   ...
   (save-excursion
	 ...
	 (if (consp containing-sexp)
	   ...
	   (if (c-looking-at-inexpr-block)
	     ...
	     (when (and (or (c-major-mode-is 'java-mode)
                            (c-major-mode-is 'csharp-mode))
			(eq (char-after) ?\[))
	       ;; In Java or C#, an initialization brace list may follow
	  ...
	  (cond
	   ...
	   ((setq special-brace-list
		...
		(or (consp special-brace-list)
		  ...
		  ;; We're in Java or C#, and have found that the open brace
		...
		(c-add-syntax 'statement-cont (c-point 'boi))))
	     ...
	     (t
	      ...
	      (goto-char (or (and after-cond-placeholder
			     ...
			     (point)))
	      (c-add-syntax 'statement-cont (point)))
;	      (c-add-syntax 'defun-block-intro-cont (point)))
	     )))
