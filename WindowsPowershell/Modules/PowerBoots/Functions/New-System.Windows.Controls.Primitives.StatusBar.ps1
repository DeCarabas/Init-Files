...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "StatusBar not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "StatusBar in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.Primitives.StatusBar {
<#
.Synopsis
   Create a new StatusBar object
.Description
   Generates a new System.Windows.Controls.Primitives.StatusBar object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.Primitives.StatusBar
   $All = Get-Parameter New-System.Windows.Controls.Primitives.StatusBar | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.Primitives.StatusBar @PSBoundParameters
