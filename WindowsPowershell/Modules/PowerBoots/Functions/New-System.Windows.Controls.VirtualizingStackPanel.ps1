...
if($ExecutionContext.SessionState.Module.Guid -ne (Get-BootsModule).Guid) {
	Write-Warning "VirtualizingStackPanel not invoked in PowerBoots context. Attempting to reinvoke."
   $scriptParam = $PSBoundParameters
   return iex "& (Get-BootsModule) '$($MyInvocation.MyCommand.Path)' `@PSBoundParameters"
}
# Write-Host "VirtualizingStackPanel in module $($executioncontext.sessionstate.module) context!" -fore Green


function Global:New-System.Windows.Controls.VirtualizingStackPanel {
<#
.Synopsis
   Create a new VirtualizingStackPanel object
.Description
   Generates a new System.Windows.Controls.VirtualizingStackPanel object, and allows setting all of it's properties
.Notes
...
BEGIN {
   $DObject = New-Object System.Windows.Controls.VirtualizingStackPanel
   $All = Get-Parameter New-System.Windows.Controls.VirtualizingStackPanel | ForEach-Object { $_.Key } | Sort
}
PROCESS {
...
New-System.Windows.Controls.VirtualizingStackPanel @PSBoundParameters
